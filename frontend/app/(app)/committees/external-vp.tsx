...
const COMMITTEE_SLUG = 'external-vp';
...
export default function ExternalVPScreen() {
    ...
    // If not approved, show the hero header with join prompt
    if (!isApproved) {
        return (
    ...
    // Approved members see the full content
    const headerContent = (
        <>
            <CommitteeHeroHeader committee={committee} />
